...
class AnaliticLike extends Model
{
    protected $table = 'analitic_favorite';
    protected $fillable = ['user_id', 'time', 'course', 'type'];

    public static function addAnalitic($user, $like, $type){
    	Self::create([
    		'user_id' => $user,
    		'time' => time(),
    		'course' => $like,
    ...
    public static function getCountLike(){
