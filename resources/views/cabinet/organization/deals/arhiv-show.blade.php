...
$title = (App::isLocale('ru'))? 'Сделки (Архив)' : 'Угоди (Архiв)';
$description = '';
$keywords = '';
                                ...
                                <div class="deals-edit__item">
                                    ...
                                    <div class="deals-edit__item-input-wrap edit_name_deals">
                                        <p class="deals-edit__item-label">
                                            {{ (App::isLocale('ru'))? 'Имя Заявки:' : 'Ім`я Заявки:' }}
                                        </p>
                                        <label for="deals_edit_name" class="visually-hidden">
                                            Названия
                                        </label>
                                        <input type="text" name="deals_edit_name" class="deals-edit__item-input" id="deals_edit_name">
                                    </div>
                            ...
                            <div class="deals-edit__edit-left">
                                ...
                                <div class="deals-edit__item">
                                    ...
                                    <div class="deals-edit__item-input-wrap">
                                        ...
                                        <div class="deals-edit__item__input-content">
                                            ...
                                            <input type="tel" name="deals_edit_list_tel" class="deals-edit__item-input" id="deals_edit_list_tel" value="{{ $deal->phone_user }}">
                                        </div>
                                        <button type="button" class="deals-edit__button-edit" aria-label="Редактировать Названия">
                                            <svg width="16" height="15">
                                                <use xlink:href="#icon-pen"></use>
                                ...
                                <div class="deals-edit__item">
                                    ...
                                    <div class="deals-edit__item-input-wrap">
                                        ...
                                        <div class="deals-edit__item__input-content">
                                            ...
                                            <input type="email" name="deals_edit_list_email" class="deals-edit__item-input" id="deals_edit_list_email" value="{{ $deal->email_user }}">
                                        </div>
                                        <button type="button" class="deals-edit__button-edit" aria-label="Редактировать Названия">
                                            <svg width="16" height="15">
                                                <use xlink:href="#icon-pen"></use>
                                ...
                                <div class="deals-edit__item">
                                    ...
                                    <div class="deals-edit__item-input-wrap">
                                        ...
                                        <div class="deals-edit__item__input-content">
                                            <input type="text" name="date" class="datetimepicker deals-edit__item-input" value="{{ date('d.m.Y, H:i:s', $deal->time) }}" />
                                        </div>
                                        <button type="button" class="deals-edit__button-edit" aria-label="Редактировать Названия">
                                            <svg width="16" height="15">
                                                <use xlink:href="#icon-pen"></use>
                            ...
                            <div class="deals-edit__edit-right">
                                ...
                                <div class="deals-edit__item">
                                    ...
                                    <div class="deals-edit__item-input-wrap">
                                        ...
                                        <div class="deals-edit__item__input-content">
                                            ...
                                            <input type="text" name="budget" class="deals-edit__item-input" id="deals_edit_list_sum" value="{{ $deal->budget }}">
                                        </div>
                                        <button type="button" class="deals-edit__button-edit" aria-label="Редактировать Названия">
                                            <svg width="16" height="15">
                                                <use xlink:href="#icon-pen"></use>
                                ...
                                <div class="deals-edit__item">
                                    ...
                                    <div class="deals-edit__item-input-wrap">
                                        ...
                                        <div class="deals-edit__item__input-content">
                                            <input type="text" name="date_course" class="datetimepicker deals-edit__item-input" value="{{ date('d.m.Y, H:i:s', $deal->date_course) }}" />
                                        </div>
                                        <button type="button" class="deals-edit__button-edit" aria-label="Редактировать Названия">
                                            <svg width="16" height="15">
                                                <use xlink:href="#icon-pen"></use>
