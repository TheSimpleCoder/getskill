          		...
          		<div class="deals">
            		<div class="deals__top">
              			...
              			<div class="deals__button">
                			<a href="{{ route('cabinet.organization.deals', App::getLocale()) }}" class="button button--add-something button--gray button--icon-transform-svg">
	                  				...
	                  				<div class="action-circle__wrapper">
	                    				<div class="action-circle__list">
											<div class="action-circle__item">
												<a href="{{ route('cabinet.organization.revoke', ['locale' => App::getLocale(), 'id' => $list->id]) }}" class="edit action-circle__edit" aria-label="Редактировать">
	                          						↺
	                        					</a>
	                      					</div>
	                      					<div class="action-circle__item">
	                      						...
	                      						<form method="POST" action="{{ route('cabinet.organization.deleteDeals', App::getLocale()) }}">
	                      							...
	                      							<input type="hidden" name="type" value="delFromArch">
	                      					...
	                      					<div class="action-circle__item">
	                        					<a href="{{ route('cabinet.organization.dealsArhivShow', ['locale' => App::getLocale(), 'id' => $list->id]) }}" class="edit action-circle__edit" aria-label="Редактировать">
