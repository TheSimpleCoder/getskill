...
$title = trans('auth/register-person.Title');
$description = '';
$keywords = '';
            ...
            <div class="container registration__inner">
                <ul class="registration__menu">
                    <li class="registration__item registration__item--active">
                        <a>{{ __('auth/register-person.Menu item user') }}</a>
                    </li>
                    <li class="registration__item">
                        <a href="{{ route('register-organization', app()->getLocale()) }}">{{ __('auth/register-person.Menu item organization') }}</a>
                    </li>
                </ul>
            </div>
        </div>
