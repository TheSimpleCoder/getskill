...
@section('admin-content')
    ...
    <a href="{{ route('admin.course.update', $course) }}?status=1" class="btn btn-success" style="margin-bottom: 20px;">Одобрить</a>
    <form method="GET" action="{{ route('admin.course.update', $course) }}">
