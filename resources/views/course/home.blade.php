                    		...
                    		<article class="product product--top">
                      			<div class="product__picture">
                        			<a href="{{ route('course_page_info', ['locale' => app()->getLocale(), 'id' => $top->id]) }}" class="product__img">
                          				<picture>
                            				<img src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAEALAAAAAAQAAkAAAIKjI+py+0Po5yUFQA7" data-src="{{ $top->logo_course }}" class="lazy" width="280" height="155" alt="{{ $top->name_ru }}">
                          				</picture>
                        			</a>
                      			</div>
