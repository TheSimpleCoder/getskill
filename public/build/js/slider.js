...
(function () {
  ...
  cabinetMenu.slick({
    ...
    slidesToShow: 1,
    slidesToScroll: 1,
    prevArrow: '<button class="menu-cabinet__prev"><svg width="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 443.52 443.52"><path d="M143.492 221.863L336.226 29.129c6.663-6.664 6.663-17.468 0-24.132-6.665-6.662-17.468-6.662-24.132 0l-204.8 204.8c-6.662 6.664-6.662 17.468 0 24.132l204.8 204.8c6.78 6.548 17.584 6.36 24.132-.42 6.387-6.614 6.387-17.099 0-23.712L143.492 221.863z"/></svg></button>',
    nextArrow: '<button class="menu-cabinet__next"><svg width="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005"><path d="M388.418 240.923L153.751 6.256c-8.341-8.341-21.824-8.341-30.165 0s-8.341 21.824 0 30.165L343.17 256.005 123.586 475.589c-8.341 8.341-8.341 21.824 0 30.165a21.275 21.275 0 0015.083 6.251 21.277 21.277 0 0015.083-6.251l234.667-234.667c8.34-8.34 8.34-21.823-.001-30.164z"/></svg></button>',
    centerMode: true,
    centerPadding: '54px',
    mobileFirst: true,
    responsive: [
